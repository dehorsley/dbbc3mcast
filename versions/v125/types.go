...
type (
	...
	Core3h struct {
		...
		Tsys             uint32 `json:"tsys"`
		Sefd             uint32 `json:"sefd"`
	}
	...
	Bbc struct {
		...
		BitStatistics       map[string]uint32 `json:"bit_statistics"`
		TsysUSB             uint16            `json:"tsys_usb"`
		TsysLSB             uint16            `json:"tsys_lsb"`
		SEFDUSB             uint16            `json:"sefd_usb"`
		SEFDLSB             uint16            `json:"sefd_lsb"`
	}
